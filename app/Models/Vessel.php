...
class Vessel extends BaseModel
{
    ...
    const FIELDS_CDT = '
        ...
        -1 AS vrpid,
        0 AS vrp_import,
        (v1.active_field_id AND c1.active_field_id) AS djs_active,
        c1.networks_active,
        ...
        0 AS vrp_status,
        p1.id AS plan_id,
        p1.plan_number AS plan_number,
        c1.id AS company_id,
        c1.has_photo AS company_has_photo,
        c1.name AS company_name,
        p1.plan_number AS company_plan_number,
        c1.active_field_id AS company_active,
        0 AS vrp_vessel_is_tank,
        t.name AS type,
        v1.tanker,
        vs.id IS NOT NULL AS resource_provider,
        v1.active_field_id,
        v1.active_field_id AS coverage,
        ...
        v1.primary_poc_id,
        v1.secondary_poc_id,
        v1.sat_phone_primary,
        v1.sat_phone_secondary,
        v1.email_primary,
        v1.email_secondary,
        v1.wcd,
        v1.gross_tonnage,
        v1.construction_built,
        v1.ex_name,
        v1.created_at,
        v1.updated_at
    ';
    ...
    const UNION_FIELDS_VRP = '
        ...
        p.primary_smff LIKE "%donjon%" AS coverage,
        0 AS response,
    ...
    {
        return Arr::only($this->toArray(), ['imo', 'mmsi', 'name', 'ex_name', 'official_number']);
    }
