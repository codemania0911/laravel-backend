...
class User extends Authenticatable implements JWTSubject
{
    ...
    const FIELDS_SELECT = '
        ...
        0 AS vrp_import,
        u.active,
        u.active AND c.active_field_id AS djs_active,
        c.networks_active,
        us.status AND u.smff_service_id AS capabilies_active,
        primary_company_id,
        u.email,
        u.title,
        u.suffix,
        ...
        c.active_field_id AS company_active,
    ...
    public function isAdminOrDuty() {
        if($this->role_id == Role::ADMIN || $this->role_id == Role::DUTY_TEAM || $this->role_id == Role::NAVY_NASA || $this->role_id == Role::ACCOUNT_MANAGER) {
            return true;
        } else {
            return false;
        }
